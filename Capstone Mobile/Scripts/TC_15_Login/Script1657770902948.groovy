...
Mobile.startApplication('/Users/agung/Katalon Studio/Capstone Project/APK/Capstone Version 4.apk', false, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Welcome Page/Mulai'), 0)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Register/Masuk'), 0)
...
Mobile.tap(findTestObject('Versi3/Login/Masuk'), 0)
